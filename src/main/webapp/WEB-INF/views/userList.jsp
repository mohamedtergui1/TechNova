        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                ...
                <div class="w-full md:w-1/2">
                    <form class="flex items-center">
                        ...
                        <div class="relative w-full">
                            ...
                            <input type="text" id="simplesearch"
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tr class="border-b dark:border-gray-700">
                        ...
                        <td class="px-4 py-3 flex items-center justify-end">
                            <button id="<%= user.getId() %> user.getId() %>-button"
                                    data-dropdown-toggle="<%= user.getId() %> user.getId() %>"
                            ...
                            <div id="<%= user.getId() %> user.getId() %>"
                                 class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                <ul class="py-1 text-sm" aria-labelledby="<%= user.getId() %>-button">
                                    <li>
                                        <button type="button" data-modal-target="<%= user.getId() %>"
                                    ...
                                    <li>
                                        <button type="button" data-modal-target="deleteModal<%=user.getId()%>"
                                                data-modal-toggle="deleteModal<%=user.getId()%>"
                    ...
                    <div id="deleteModal<%=user.getId()%>" tabindex="-1" aria-hidden="true"
                        ...
                        <div class="relative p-4 w-full max-w-md max-h-full">
                            ...
                            <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                                ...
                                <p class="mb-4 text-gray-500 dark:text-gray-300">Are you sure you want to delete this
                                    item?</p>
                                <form  action="delete/<%=user.getId()%>" class="flex justify-center items-center space-x-4" method="post">
                                    ...
                                    <button type="button"
                                            ...
                                            onclick="closeModal('deleteModal<%= user.getId() %>')">No, cancel
                                    </button>
                                    <button type="submit"
                    ...
                    <!-- Update modal -->
                    <div id="<%= user.getId() %>" tabindex="-1" aria-hidden="true"
                         class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                    ...
                                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                        <div>
                                            ...
                                            <input type="text" name="firstName" value="<%=user.getFirstName()%>"
                                                   id="<%=user.getId()%>firstName" placeholder="Enter first name"
                                        ...
                                        <div>
                                            ...
                                            <input type="text" name="lastName" value="<%=user.getLastName()%>"
                                                   id="<%=user.getId()%>lastName" placeholder="Enter last name"
                                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input type="text" name="nationality" value="<%=user.getNationality()%>"
                                                   id="<%=user.getId()%>nationality" placeholder="Enter password"
                                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        </div>
                                        <div>
                                            <label for="identification"
                                                   class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">identification</label>
                                            <input type="text" name="identification"
                                                   value="<%=user.getIdentification()%>"
                                                   id="<%=user.getId()%>identification" placeholder="Enter password"
                                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        </div>
                                        <div>
                                            ...
                                            <input type="date" name="registrationDate"
                                                   value="<%=user.getRegistrationDate()%>"
                                                   id="<%=user.getId()%>registrationDate" placeholder="Enter password"
                                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        </div>
                                        <div>
                                            ...
                                            <input type="date" name="expirationDate"
                                                   value="<%=user.getExpirationDate()%>"
                                                   id="<%=user.getId()%>expirationDate" placeholder="Enter password"
                                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        </div>
                                        <div class="max-w-sm mx-auto">
                                            <label for="role"
                                                ...
                                                Role</label>
                                            <select id="<%=user.getId()%>role" name="role"
                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            ...
            <form action="" method="post">
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="text" name="nationality" id="nationality" placeholder="Enter password"
                               class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                    <div>
                        <label for="identification"
                               class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">identification</label>
                        <input type="text" name="identification" id="identification" placeholder="Enter password"
                               class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                    <div>
                        <label for="registrationDate"
                               class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Password</label>
                        <input type="date" name="registrationDate" id="registrationDate" placeholder="Enter password"
                               class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                    <div>
                        <label for="expirationDate"
                               class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Password</label>
                        <input type="date" name="expirationDate" id="expirationDate" placeholder="Enter password"
                               class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                    <div class="max-w-sm mx-auto">
